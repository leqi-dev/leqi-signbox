...
function index()
    ...
    page.index = true
    entry({"service", "datacenter", "download_file"}, call("downloadFile"), _(""), nil, true)
    entry({"service", "datacenter", "device_id"}, call("getDeviceID"), _(""), nil, true)
    entry({"service", "datacenter", "download_info"}, call("getDownloadInfo"), _(""), nil, true)
    entry({"service", "datacenter", "upload_file"}, call("uploadFile"), _(""), nil, true)
    entry({"service", "datacenter", "batch_download_info"}, call("getBatchDownloadInfo"), _(""), nil, true)
    entry({"service", "datacenter", "config_info"}, call("getConfigInfo"), _(""), nil, true)
    entry({"service", "datacenter", "set_config"}, call("setConfigInfo"), _(""), nil, true)
    entry({"service", "datacenter", "plugin_enable"}, call("enablePlugin"), _(""), nil, true)
    entry({"service", "datacenter", "plugin_download_info"}, call("pluginDownloadInfo"), _(""), nil, true)
    entry({"service", "datacenter", "plugin_disable"}, call("disablePlugin"), _(""), nil, true)
    entry({"service", "datacenter", "plugin_control"}, call("controlPlugin"), _(""), nil, true)
    entry({"service", "datacenter", "download_delete"}, call("deleteDownload"), _(""), nil, true)
    entry({"service", "datacenter", "get_plugin_status"}, call("pluginStatus"), _(""), nil, true)
    entry({"service", "datacenter", "get_connected_device"}, call("connectedDevice"), _(""), nil, true)
    entry({"service", "datacenter", "get_router_mac"}, call("getMac"), _(""), nil, true)
    entry({"service", "datacenter", "set_wan_access"}, call("setWanAccess"), _(""), nil, true)
    entry({"service", "datacenter", "get_router_info"}, call("getRouterInfo"), _(""), nil, true)
    entry({"service", "datacenter", "xunlei_notify"}, call("xunleiNotify"), _(""), nil, true)
    entry({"service", "datacenter", "get_routerIP"}, call("getRouterIP"), _(""), nil, true)
    entry({"service", "datacenter", "multi_create"}, call("MultiCreate"), _(""), nil, true)
    entry({"service", "datacenter", "run_command"}, call("RunCommand"), _(""), nil, true)
end
